  ...
  return (
    <div className="panel">
      ...
      <div className="panel-sub">
        За друга, который оформит подписку, — процент на баланс. Выводи реальными деньгами или
        оплачивай свою подписку.
      </div>
        ...
        <ol className="ref-steps" role="list">
          ...
          <li className="ref-step">
            ...
            <div className="ref-step-body">
              ...
              <p>
                {hasTrial
                  ? `По твоей ссылке он получает ${trialLabel} бесплатно и +2 устройства на любом плане.`
                  : "Он оформляет подписку по твоей ссылке и получает +2 устройства на любом плане."}
              </p>
            </div>
          </li>
          <li className="ref-step">
