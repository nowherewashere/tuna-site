...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Есть бесплатный пробный период, без карты. Настраивать вручную ничего не нужно: подписка добавляется в приложение Happ одним нажатием. Если что-то не пошло — меняешь локацию или протокол, поддержка помогает на любом шаге.",
      },
    },
    {
      "@type": "Question",
          ...
          <div className="wrap">
            ...
            <div className="faq-list">
              ...
              <details className="q">
                ...
                <p>
                  Есть — бесплатно и без карты. Так ты спокойно проверяешь всё до оплаты.
